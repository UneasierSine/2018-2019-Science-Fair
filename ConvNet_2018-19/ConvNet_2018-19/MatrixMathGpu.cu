...
//
//	thrust::transform(d_v1.begin(), d_v1.end(), d_v2.begin, d_rV.begin(), thrust::plus<double>());
//
...
//	device_vector<double> d_v2 = vec2;
//
//	transform(d_v1.begin(), d_v1.end(), d_v2.begin, d_rV.begin(), thrust::minus<double>());
//
//	deviceToCppVec(d_rV, returnVec);
//	return returnVec;
//}
...
//	device_vector<double> d_v2 = vec2;
//
//	transform(d_v1.begin(), d_v1.end(), d_v2.begin, d_rV.begin(), thrust::multiplies<double>());
//
//	deviceToCppVec(d_rV, returnVec);
//	return returnVec;
//}
...
//	device_vector<double> d_v2 = vec2;
//
//	transform(d_v1.begin(), d_v1.end(), d_v2.begin, d_rV.begin(), thrust::divides<double>());
//
//	deviceToCppVec(d_rV, returnVec);
//	return returnVec;
//}
